<html>
	...
	<body>
		...
		<div class="container">
			...
			<p class="pFont norm">
			Majestic Casual Search is a search engine for the Majestic Casual YouTube channel. </br>
		This site has no affiliation with Majestic Casual.</br></br>
		I'm aware that my definition of any genre is most likely different from yours.
		However, If you do find any discrepancies please feel free to let me know. 
		I also apologize for the weird layout of the site, I'm no web designer. Feedback is appreciated!</br>
		Contact me at kzachary4@gmail.com. <br/>Thanks.</p>
